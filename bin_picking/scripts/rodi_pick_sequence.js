...
var PAYLOAD_TOOL = 1.5;         // 그리퍼만 [kg] 🚨 [확인필요] 견적서 1.2 / 140형 1.25 / 85형 공식값 없음
var PAYLOAD_PART = 0.05;        // 부품 1개 추정 [kg] 🚨 [실측필요] 저울로 잰다 (문서엔 0.94 라는 출처불명 값이 있다 = 19배 차이)
var PART_COM     = { x: 0, y: 0, z: 50 };   // 무게중심 (ko:129 예제 형식)
// 🎥 카메라를 팔에 달면 여기에 더한다: Blaze < 680g [확인·Basler 공식] + ace2 100g [확인] + 브라켓 [실측필요]
//    🚨 카메라는 옆으로 붙어 무게중심이 x·y 로도 이동한다 ⇒ PART_COM 만으로 부족하고 TOOL 쪽 CoM 도 갱신 대상
