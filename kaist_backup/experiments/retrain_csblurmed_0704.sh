...
LOG=$RUNS/retrain_csblurmed_0704.log
MAX_RETRY=2
NAME=csblurmed
DATA=$ROOT/data/2d_dataset_camsweep_blur_medium

echo "===== camsweep+edgeblur_medium 재학습 시작 $(date) =====" | tee -a $LOG
...
echo "===== camsweep+edgeblur_medium 재학습 종료 $(date) =====" | tee -a $LOG
