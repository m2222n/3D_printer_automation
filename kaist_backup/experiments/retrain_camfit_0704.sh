...
LOG=$RUNS/retrain_camfit_0704.log
MAX_RETRY=2
NAME=camfit
DATA=$ROOT/data/2d_dataset_camfit

echo "===== camsweep+edgecamfit 재학습 시작 $(date) =====" | tee -a $LOG
...
echo "===== camsweep+edgecamfit 재학습 종료 $(date) =====" | tee -a $LOG
