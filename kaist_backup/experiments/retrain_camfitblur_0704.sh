...
LOG=$RUNS/retrain_camfitblur_0704.log
MAX_RETRY=2
NAME=camfitblur
DATA=$ROOT/data/2d_dataset_camfitblur_light

echo "===== camsweep+camfit+edgeblur_light 재학습 시작 $(date) =====" | tee -a $LOG
...
echo "===== camsweep+camfit+edgeblur_light 재학습 종료 $(date) =====" | tee -a $LOG
