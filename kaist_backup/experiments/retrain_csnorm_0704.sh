...
LOG=$RUNS/retrain_csnorm_0704.log
MAX_RETRY=2
NAME=csnorm
DATA=$ROOT/data/2d_dataset_camsweep_norm01

echo "===== camsweep+norm01 재학습 시작 $(date) =====" | tee -a $LOG
...
echo "===== camsweep+norm01 재학습 종료 $(date) =====" | tee -a $LOG
