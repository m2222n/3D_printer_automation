...
LOG=$RUNS/retrain_csblurheavy_0704.log
MAX_RETRY=2
NAME=csblurheavy
DATA=$ROOT/data/2d_dataset_camsweep_blur_heavy

echo "===== camsweep+edgeblur_heavy 재학습 시작 $(date) =====" | tee -a $LOG
...
echo "===== camsweep+edgeblur_heavy 재학습 종료 $(date) =====" | tee -a $LOG
