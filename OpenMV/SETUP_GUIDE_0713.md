...
> ⛔ **폐기 — OpenMV AE3 는 7/16 대표님 회의로 폐기되고 N6 로 전환됐다.**
> 이 가이드는 **AE3 기준**이라 그대로 쓸 수 없다. 현행 방침 →
> `memory/project_ceo_meeting_0716.md`(경화기는 자동화 대상에서도 제외).
> 🚨 **N6 는 국내 재고가 없어 미입고 상태**라 대체 가이드는 아직 없다.
