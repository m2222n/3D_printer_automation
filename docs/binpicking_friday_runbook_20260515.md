...
**예상 소요**: 9:00~18:00 (셋업 1h + 검증 1h + 캡처 4~5h + 분석 1h)

---

## 📋 출근 전 가져갈 것 (목요일 밤 체크)

- [ ] 노트북 (Mac, .venv/binpick 활성화 가능)
- [ ] **다이소 회전 받침대** (수동, 5/13 구매)
- [ ] **ChArUco 보드 A4** (선택, sanity check FAIL 시만 필요)
- [ ] 부품 5종 + 카메라 + 케이블은 사무실 보관 ✅

---

## 🌅 Phase 1 — 셋업 (9:00~9:30)
...
3개 모두 ✅이면 오후 본 캡처 OK. 하나라도 ❌면 오후 디버깅.
